...
/**
 * Ticketing-owned implementation of {@link TicketIssuance}. Builds and persists one {@code VALID}
 * ticket per order line with a fresh random QR code. {@code @Transactional} so it joins the caller's
